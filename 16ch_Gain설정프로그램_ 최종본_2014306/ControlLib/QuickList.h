...
/*
	...
	Get the latest version at http://www.codeproject.com/Articles/8112/CQuickList
...
#define MSG_POST_SUBCLASS_LIST (WM_APP+50)
...
//#ifndef QUICKLIST_NOXPTHEME
	#include "theme.h"
//#endif
//#define M_Q_DELETE(p)							{ if(p) { p->DestroyWindow(); delete p;	p = NULL; } }
